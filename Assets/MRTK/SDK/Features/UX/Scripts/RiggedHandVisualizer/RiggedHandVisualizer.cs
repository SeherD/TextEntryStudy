            ...
            if (handTrackingProfile != null && handTrackingProfile.EnableHandJointVisualization)
            {
                foreach (TrackedHandJoint handJoint in eventData.InputData.Keys)
                {
                    ...
                    else
                    {
                        ...
                        else if (handJoint == TrackedHandJoint.IndexTip || handJoint == TrackedHandJoint.MiddleTip || handJoint == TrackedHandJoint.RingTip || handJoint == TrackedHandJoint.PinkyTip || handJoint == TrackedHandJoint.ThumbTip)
                        {
